...
public class DatabaseHandler extends SQLiteOpenHelper{
	...
	private static final String COLUMN7_USER = "student_id";
	...
	private static final String TABLE_NAME_STUDENT = "app_student";
	private static final String KEY_STUDENT = "_id";
	private static final String COLUMN1_STUDENT = "student_year";
	private static final String COLUMN2_STUDENT = "school";
	private static final String COLUMN3_STUDENT = "personal_desc";
	...
	public static final String CREATE_TABLE_STUDENT = "CREATE TABLE " + TABLE_NAME_STUDENT + " (" + KEY_STUDENT + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COLUMN1_STUDENT + " INTEGER, " + COLUMN2_STUDENT + " INTEGER, " + COLUMN3_STUDENT + " TEXT);" ;
