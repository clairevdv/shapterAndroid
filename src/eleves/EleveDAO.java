...
public class EleveDAO extends DAOBase{
	...
	private static final String KEY = "user_ptr_id";
	...
	public void initialiserTest() {
		Eleve e1 = new Eleve(1, 2, 1);
		Eleve e2 = new Eleve(2, 2, 1);
		Eleve e3 = new Eleve(3, 3, 1);
		Eleve e4 = new Eleve(4, 2, 1);
		Eleve e5 = new Eleve(5, 3, 1);
		Eleve e6 = new Eleve(6, 2, 1);
		Eleve e7 = new Eleve(7, 3, 1);
	...
	public void deleteEleveIndex(int id){
		//Suppression d'une Eleve de la BDD grâce à son index
